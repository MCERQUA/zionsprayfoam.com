...
export const SERVICE_CONTENT: Record<string, ServiceContent> = {
  ...
  "insulation-removal-repair": {
    ...
    sections: [
      ...
      {
        heading: "Signs You Need Removal, Not Just an Upgrade",
        body: [
      ...
      {
        heading: "What Removal and Repair Involves",
        body: [
      ...
      {
        heading: "Improperly Installed Spray Foam: A Specific Problem Worth Naming",
        body: [
    ...
    faq: [
      { q: "How do I know if my insulation needs to be removed versus just topped off?", a: "Insulation that's wet, moldy, pest-damaged, or was applied incorrectly the first time generally needs to be removed rather than covered over — adding new material on top of a failed system doesn't fix the underlying problem. An inspection is the fastest way to know for sure." },
      { q: "Do you only work on spray foam, or other insulation types too?", a: "We handle removal of any insulation type — batt, blown-in, or spray foam — when it's failed or needs to be replaced, and we'll recommend the right replacement material for your specific situation." },
    ],
    relatedSlugs: ["attic-insulation", "crawl-space-insulation"],
  },
};
